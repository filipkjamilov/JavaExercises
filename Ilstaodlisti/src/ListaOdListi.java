...
// Konstrukcija Konstrukcija na nov, prazen stek.
    ...
    public E peek () {
        if (top == null)
            throw new NoSuchElementException("Prazen magacinn");
        return top.element;
    }
    public void clear () {
        top = null;
    ...
    public E pop () {
        if (top == null)
            throw new NoSuchElementException("Prazen magacin");
...
public class ListaOdListi {
    ...
    public static void findMagicNumber(DLL<DLL<Integer>> list) {

        DLLNode<DLL<Integer>> tmp = list.getFirst();
        LinkedStack<Long> stek = new LinkedStack<Long>();

        long suma=0;

        while(tmp != null){
            DLLNode<Integer> p1 = tmp.element.getFirst();
            while (p1 != null){
                suma+=p1.element;
                p1 = p1.succ;
            }
