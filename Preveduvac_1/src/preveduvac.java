...
// Delete the entry (if any) whose key is equal to key from thisOBHT.
        int b = hash(key); int n_search=0;
        for (;;) {
            MapEntry<K,E> oldEntry = buckets[b];
            if (oldEntry == null)
...
public class preveduvac{
    public static void main(String[] args) throws IOException {
        ...
        OBHT<String, String> tabela = new OBHT<String, String>(N*2);
        ...
        while(true){
            ...
            if(tabela.search(linija)!=-1){
                int index = tabela.search(linija);
                System.out.println(tabela.atIndex(index).value);
            }
            else{
                System.out.println("/");
            }
