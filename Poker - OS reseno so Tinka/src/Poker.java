...
public class Poker {
    ...
    static Semaphore vleguvam_na_masa;
    static Semaphore povikuva_Diler_za_igra;
    static Semaphore sum_zavrshil_so_igra;
    static int num;
    static Object obj;
    ...
    public static void init() {
        ...
        vleguvam_na_masa=new Semaphore(6);
        povikuva_Diler_za_igra=new Semaphore(0);
        sum_zavrshil_so_igra=new Semaphore(6);
        num=0;
        obj = new Object();
    }
    ...
    public static class Player extends TemplateThread {
        ...
        public void execute() throws InterruptedException {
            ...
            vleguvam_na_masa.acquire();
            //shtom ima mesto vednash sednuvam na masa i si chekam
            state.playerSeat();
            ...
            if (num==6){
                state.dealCards(); //znachi ako vekje nemoze da vleguvaat drugi, vikni go dilerot
                povikuva_Diler_za_igra.release(6);

            }

            povikuva_Diler_za_igra.acquire(); //sakaat da vlezat ama ima 0 permits
            //oni se vekje naredeni 6, chekat 6 realease, e sega mozat da pochnat
            state.play();
            //sum_zavrshil_so_igra.acquire();
            ...
            if (num==0){
                //znachi oti e posledniot
                state.endRound();
                //sum_zavrshil_so_igra.release(6);
                vleguvam_na_masa.release(6);
            }
        }
